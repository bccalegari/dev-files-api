...
public abstract class AbstractTestContainersTest {
    ...
    public static final GenericContainer<?> REDIS_CONTAINER = new GenericContainer<>("redis:6-alpine")
            .withReuse(true)
            .withExposedPorts(6379)
            .withEnv("REDIS_PASSWORD", "123");

    public static final GenericContainer<?> RABBITMQ_CONTAINER = new GenericContainer<>("rabbitmq:4.0-rc-management-alpine")
            .withReuse(true)
